    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(function() {
                    ...
                    successMessage.style.cssText = 'background-color: #d4edda; color: #155724; padding: 1rem; border-radius: 4px; margin-top: 1rem; text-align: center;';
                ...
                .catch(function() {
                    ...
                    errorMessage.style.cssText = 'background-color: #f8d7da; color: #721c24; padding: 1rem; border-radius: 4px; margin-top: 1rem; text-align: center;';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest && (input.closest('input') || input.closest('textarea') || input.closest('select'))) {
                ...
                if (validator && input.classList.contains('input-error')) {
                    const error = validator(input.value);
                    if (!error) {
                        clearError(input);
                    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c643f042-326e-4a55-a2a8-f89b257a7879',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c643f042-326e-4a55-a2a8-f89b257a7879';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c643f042-326e-4a55-a2a8-f89b257a7879';
